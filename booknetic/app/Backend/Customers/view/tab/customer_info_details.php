    ...
    <div class="row mt-3">
        <div class="col-lg-6">
            <div class="modal_payment-card">
                ...
                <span class="text-break"><?php echo empty($customer['email']) ? bkntc__('N/A' ) : $customer['email']; ?></span>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="modal_payment-card">
                ...
                <span><?php echo empty($customer['phone_number']) ? bkntc__('N/A' ) : $customer['phone_number']; ?></span>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="modal_payment-card">
                ...
                <span><?php echo empty($customer['birthdate']) ? bkntc__('N/A' ) : $customer['birthdate']; ?></span>
            </div>
        </div>
    </div>
</div>