...
class AppointmentService
{
	...
	public static function createAppointment( AppointmentRequests $appointmentRequests )
	{
        ...
        if( $appointmentRequests->calledFromBackend )
        {
            $appointment = Appointment::where('customer_id',$appointmentRequests->currentRequest()->customerId)
                ->where('client_timezone','<>','-')->fetch();
            ...
            $clientTimezone = $appointmentRequests->currentRequest()->clientTimezone;
        }
