...
class Controller extends \BookneticApp\Providers\Core\Controller
{
	...
	public function index()
	{
        ...
        foreach( AppointmentExtra::select( 'DISTINCT ' . AppointmentExtra::getField( 'extra_id' ) )->leftJoin( ServiceExtra::class, [ 'id', 'name' ], ServiceExtra::getField( 'id' ), AppointmentExtra::getField( 'extra_id' ), true )->fetchAll() AS $appointmentExtra  )
        {
