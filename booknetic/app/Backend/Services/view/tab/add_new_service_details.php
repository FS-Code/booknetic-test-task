        ...
        <div class="form-group col-md-6">
            <div class="form-control-checkbox">
                ...
                <span class="repeatable_text">
                    <i class="fa fa-info-circle help-icon do_tooltip" data-content="<?php echo bkntc__( 'Provide an opportunity to your customers to choose multiple days while making appointments' ); ?>"></i>
