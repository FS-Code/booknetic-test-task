...
class Helper
{
	...
	public static function _post( $key , $default = null , $check_type = null , $whiteList = [] )
	{
		...
		if( $res !== $default && !is_null( $check_type ) )
		{
            ...
            {
                $res = json_decode( trim( stripslashes_deep( (string)$res ) ), true );
    ...
    public static function getRedirectURL()
    {
        ...
        {
            return add_query_arg( 'redirect_to', urlencode( $currentPage ), get_permalink( $signPageForCustomers ) );
        }
    ...
    public static function timeslotsAsMinutes()
    {
    ...
    public static function canShowTemplates()
    {
        $notSelected = Helper::getOption( 'selected_a_template', '0' ) === '0';

        //if it's regular version return the option's value
